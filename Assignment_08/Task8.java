...
public class Task8{
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      System.out.println("retrieve and print Doc: "+ fetchedDocument );
    } catch (Exception e) {
      e.printStackTrace();
    }
    ...
    try {
      ...
      fetchedDocument = myBucket.fetch(key, String.class).execute();
      System.out.println("modify and retrieve and print: " + fetchedDocument );
    } catch (Exception e) {
      e.printStackTrace();
    }
    ...
    try {
      ...
      fetchedDocument = myBucket.fetch(key, String.class).execute();
      System.out.println("delete and retrieve and print: " + fetchedDocument );
    } catch (Exception e) {
      e.printStackTrace();
    }
